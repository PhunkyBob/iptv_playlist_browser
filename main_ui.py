...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_wait.setGeometry(QtCore.QRect(20, 150, 831, 241))
        font = QtGui.QFont()
        ...
        self.menuXtream = QtWidgets.QMenu(self.menuTools)
        self.menuXtream.setObjectName("menuXtream")
        ...
        self.action_Download_playlist_lite = QtWidgets.QAction(MainWindow)
        self.action_Download_playlist_lite.setObjectName("action_Download_playlist_lite")
        self.action_Download_playlist_full = QtWidgets.QAction(MainWindow)
        self.action_Download_playlist_full.setObjectName("action_Download_playlist_full")
        self.action_Generate_playlist = QtWidgets.QAction(MainWindow)
        self.action_Generate_playlist.setEnabled(False)
        self.action_Generate_playlist.setObjectName("action_Generate_playlist")
        self.action_Account_infos = QtWidgets.QAction(MainWindow)
        self.action_Account_infos.setObjectName("action_Account_infos")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuXtream.setTitle(_translate("MainWindow", "Xtream"))
        self.toolBar.setWindowTitle(_translate("MainWindow", "toolBar"))
        self.action_api.setText(_translate("MainWindow", "&Xtream Code API..."))
        self.action_api.setToolTip(_translate("MainWindow", "Xtream Code API"))
        ...
        self.action_Download_playlist_lite.setText(_translate("MainWindow", "Download playlist (lite)"))
        self.action_Download_playlist_full.setText(_translate("MainWindow", "Download playlist (full)"))
        self.action_Generate_playlist.setText(_translate("MainWindow", "Generate playlist..."))
        self.action_Account_infos.setText(_translate("MainWindow", "Account infos"))
